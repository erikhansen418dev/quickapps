 ...
 * to {@link mobeta.android.dslv.DragSortListView#setAdapter(android.widget.ListAdapter)} and, since
 * this class implements the {@link mobeta.android.dslv.DragSortListView.DragSortListener}
...
public abstract class DragSortCursorAdapter extends CursorAdapter implements 
     ...
     *
     * @see mobeta.android.dslv.DragSortListView.DropListener#drop(int, int)
     */
    @Override
     ...
     * the current mapping with {@link getCursorPositions()}.
     *
     * @see mobeta.android.dslv.DragSortListView.RemoveListener#remove(int)
     */
    @Override
